  ...
  html: `
    ...
    <section class="content-section" id="registros" data-searchable>
      ...
      <div class="gallery-grid" data-gallery>
        ...
        <button class="gallery-item gallery-wide" type="button" data-full="assets/images/journey/perfil-msa.webp" data-caption="Ejemplo de perfil en el programa con el hito Senior."><img src="assets/images/journey/perfil-msa.webp" alt="Ejemplo de perfil en Student Ambassadors con el hito Senior"><span>Ejemplo de perfil en el programa</span></button>
      ...
      <p class="photo-credit">Imagen de portada basada en una foto de Startup Stock Photos en Pexels.</p>
    </section>
