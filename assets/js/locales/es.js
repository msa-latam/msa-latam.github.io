  ...
  html: `
    ...
    <section class="content-section" id="programa" data-searchable>
      ...
      <div class="rich-text">
        ...
        <p>Thiago Kusal ingresó al programa en 2024 y avanzó hasta Senior Student Ambassador. En agosto de 2026, él y <a href="https://www.linkedin.com/in/jhonatan-lobo/" target="_blank" rel="noopener noreferrer">Jhonatan Lobo</a> eran los dos Seniors activos en Brasil. Esta situación puede cambiar cuando nuevos Ambassadors progresen.</p>
      </div>
    </section>
    ...
    <section class="content-section path-section" id="influencer" data-searchable>
      ...
      <div class="subsection"><h3>Herramientas opcionales</h3><p>Agregar el ID manualmente es suficiente. La comunidad también creó soluciones, como la extensión original de Martin Brandl y la Azure Function de Barbara Forbes. El proyecto original de la extensión fue archivado, y una adaptación al flujo actual está en <a href="https://github.com/tkusal/ambassador-referral-linker" target="_blank" rel="noopener noreferrer">Ambassador Referral Linker</a>.</p><p class="small-note">No son productos oficiales de Microsoft. Revisa siempre la URL final.</p></div>
    ...
    <section class="content-section references-section" id="referencias" data-searchable>
      <div class="section-heading"><span class="section-kicker">FUENTES DE VERDAD</span><h2>Referencias oficiales</h2><p>Usa estas páginas y los mensajes del equipo para confirmar las reglas vigentes.</p></div>
