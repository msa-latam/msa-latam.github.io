  ...
  html: `
    ...
    <section class="content-section" id="programa" data-searchable>
      ...
      <div class="rich-text">
        ...
        <p>Thiago Kusal joined the program in 2024 and progressed to Senior Student Ambassador. In August 2026, he and <a href="https://www.linkedin.com/in/jhonatan-lobo/" target="_blank" rel="noopener noreferrer">Jhonatan Lobo</a> were the two active Seniors in Brazil. This snapshot can change as other Ambassadors progress.</p>
      </div>
    </section>
    ...
    <section class="content-section path-section" id="influencer" data-searchable>
      ...
      <div class="subsection"><h3>Optional tools</h3><p>Adding the ID manually is enough. Community solutions have included Martin Brandl's original extension and Barbara Forbes's Azure Function. The original extension was archived, and an adaptation for the current flow is available at <a href="https://github.com/tkusal/ambassador-referral-linker" target="_blank" rel="noopener noreferrer">Ambassador Referral Linker</a>.</p><p class="small-note">These are not official Microsoft products. Always inspect the final URL.</p></div>
    ...
    <section class="content-section" id="registros" data-searchable>
      ...
      <div class="gallery-grid" data-gallery>
        ...
        <button class="gallery-item gallery-wide" type="button" data-full="assets/images/journey/perfil-msa.webp" data-caption="Thiago Kusal's program profile at the Senior milestone."><img src="assets/images/journey/perfil-msa.webp" alt="Thiago Kusal's Student Ambassadors profile showing the Senior milestone"><span>Program profile</span></button>
        ...
        <button class="gallery-item gallery-wide" type="button" data-full="assets/images/journey/atividade-em-comunidade.webp" data-caption="A collaborative technical activity with students."><img src="assets/images/journey/atividade-em-comunidade.webp" alt="A group of students in a collaborative technical activity"><span>Learning in community</span></button>
      </div>
      <p class="photo-credit">Community activity photo by <a href="https://www.pexels.com/photo/people-with-laptops-at-lecture-in-technical-school-19895774/" target="_blank" rel="noopener noreferrer">ThisIsEngineering on Pexels</a>, under the Pexels license. Cover composition based on a Startup Stock Photos image on Pexels.</p>
    </section>
    ...
    <section class="content-section references-section" id="referencias" data-searchable>
      <div class="section-heading"><span class="section-kicker">SOURCES OF TRUTH</span><h2>Official references</h2><p>Use these pages and messages from the program team to confirm current rules.</p></div>
      <ul class="reference-list"><li><a href="https://mvp.microsoft.com/studentambassadors/" target="_blank" rel="noopener noreferrer">Microsoft Student Ambassadors</a></li><li><a href="https://mvp.microsoft.com/faq?section=student" target="_blank" rel="noopener noreferrer">Student Ambassadors FAQ</a></li><li><a href="https://mvp.microsoft.com/studentambassadors/milestones" target="_blank" rel="noopener noreferrer">Program milestones</a></li><li><a href="https://aka.ms/sacoc" target="_blank" rel="noopener noreferrer">Code of Conduct</a></li><li><a href="https://learn.microsoft.com/training/student-hub/become-a-student-ambassador?wt.mc_id=studentamb_365381" target="_blank" rel="noopener noreferrer">Microsoft Learn Student Hub</a></li><li><a href="https://learn.microsoft.com/azure/education-hub/find-ids?wt.mc_id=studentamb_365381" target="_blank" rel="noopener noreferrer">Azure for Students</a></li><li><a href="https://learn.microsoft.com/credentials/applied-skills/?wt.mc_id=studentamb_365381" target="_blank" rel="noopener noreferrer">Microsoft Applied Skills</a></li><li><a href="https://learn.microsoft.com/training/support/plans?wt.mc_id=studentamb_365381" target="_blank" rel="noopener noreferrer">Microsoft Learn Plans overview</a></li><li><a href="https://learn.microsoft.com/training/support/plans-create-manage?wt.mc_id=studentamb_365381" target="_blank" rel="noopener noreferrer">Create and manage Plans</a></li></ul>
    </section>
  `
};
